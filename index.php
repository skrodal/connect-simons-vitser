 ...
 *
 * Spesielt scopes og brukerinfo over er byttig for å styre tilgang. Legg merke til at api-navn i scopet (i eks gk_simons-vitser_15) droppes 
 * i headere og kun siste del (15) sendes med.
 *
 * En klient kan ha tilgang til 1-mange scopes. Klienten kan også bestemme seg for redusere/øke scopes i 
 * sin request basert på hvilken bruker som er logget på. 
 * 
